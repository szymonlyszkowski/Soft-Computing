...
def train_network(training_periods_amount, list_of_tuples_training_set_expected_outputs):
    for _ in xrange(training_periods_amount):
        run_training_period(list_of_tuples_training_set_expected_outputs)


def run_training_period(list_of_tuples_training_set_expected_outputs):
