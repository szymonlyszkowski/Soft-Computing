...
class KohonenNetwork(AbstractNeuralNetwork):
    ...
    def train_kohonen_network(self, training_periods):
        for _ in xrange(0, training_periods):
            ...
            winner_neuron_index = self.__get_maximum_nan_output_index(neurons_outputs)
    ...
    @classmethod
    def __get_maximum_nan_output_index(cls, neurons_outputs):
        try:
            return numpy.nanargmax(neurons_outputs)
        except ValueError:
            return 0
